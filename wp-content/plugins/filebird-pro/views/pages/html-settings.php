    ...
    <table class="form-table">
      ...
      <tr>
        <th scope="row">
          ...
          <p class="description" style="font-weight: 400"><?php _e('By running this action, your newly created folders in this FileBird 4.x will be replaced by all folders created in the previous version.', 'filebird'); ?></p>
        </th>
        <td>
...
if(isset($_GET['autorun']) && ($_GET['autorun'] == 'true')) {
  ...
  <script>
    ...
    var njt_fb_settings_page = '<?php echo esc_url(add_query_arg(array('page' => 'filebird-settings'), admin_url('options-general.php'))) ?>';
