...
class Folder extends Controller {
      ...
      if($old_folder_count > 0 && !isset($_GET['autorun'])) {
        ...
        <div class="notice notice-warning is-dismissible njt-fb-update-db-noti" id="njt-fb-update-db-noti">
          <div class="njt-fb-update-db-noti-item">
            <h3><?php _e('FileBird database update required', 'filebird'); ?></h3>
          </div>
          <div class="njt-fb-update-db-noti-item">
            <p>
              <?php _e('FileBird has been updated! To use the latest version, you have to update your database to make your FileBird folders display correctly.', 'filebird'); ?>
            </p>
          </div>
          <div class="njt-fb-update-db-noti-item">
            <p>
            <a class="button button-primary" href="<?php echo esc_url(add_query_arg(array('page' => 'filebird-settings', 'autorun' => 'true'), admin_url('/options-general.php'))); ?>">
              <strong><?php _e('Update FileBird Database', 'filebird')?></strong>
            </a>
            </p>
          </div>
        </div>
  ...
  public function enqueueAdminScripts($screenId) {
    ...
    wp_localize_script('fbv-folder', 'fbv_data', array(
      ...
      'auto_import_url' => esc_url(add_query_arg(array('page' => 'filebird-settings', 'autorun' => 'true'), admin_url('/options-general.php')))
    ));
  }
